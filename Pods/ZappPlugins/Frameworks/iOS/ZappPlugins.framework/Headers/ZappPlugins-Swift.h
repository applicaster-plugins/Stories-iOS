...
/// returns:
/// react native packager root url, as defined by zapptool
- (NSString * _Nullable)sessionStorageValueFor:(NSString * _Nonnull)key namespace:(NSString * _Nullable)namespace_ SWIFT_WARN_UNUSED_RESULT;
- (BOOL)sessionStorageSetValueFor:(NSString * _Nonnull)key value:(NSString * _Nonnull)value namespace:(NSString * _Nullable)namespace_ SWIFT_WARN_UNUSED_RESULT;
- (NSString * _Nullable)sessionStorageAllValues SWIFT_WARN_UNUSED_RESULT;
- (NSString * _Nonnull)sessionStorageApplicasterNamespace SWIFT_WARN_UNUSED_RESULT;
- (NSString * _Nullable)localStorageValueFor:(NSString * _Nonnull)key namespace:(NSString * _Nullable)namespace_ SWIFT_WARN_UNUSED_RESULT;
- (BOOL)localStorageSetValueFor:(NSString * _Nonnull)key value:(NSString * _Nonnull)value namespace:(NSString * _Nullable)namespace_ SWIFT_WARN_UNUSED_RESULT;
- (NSString * _Nullable)localStorageAllValues SWIFT_WARN_UNUSED_RESULT;
@end
...
- (BOOL)isDownloadExpirationDateValid SWIFT_WARN_UNUSED_RESULT;
@end
